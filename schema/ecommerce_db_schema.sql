...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 26, 2025 at 09:56 AM
...
--
-- Table structure for table `discount_code_category`
--

CREATE TABLE `discount_code_category` (
...
CREATE TABLE `orders` (
  ...
  `provider_ids` json DEFAULT NULL,
...
CREATE TABLE `transactions` (
  ...
  `processed_via` enum('webhook','controller') DEFAULT NULL,
...
--
-- Indexes for table `discount_code_category`
--
ALTER TABLE `discount_code_category`
  ADD PRIMARY KEY (`discount_code_id`,`category_id`),
  ADD KEY `discount_code_category_category_id_foreign` (`category_id`);
...
ALTER TABLE `email_otps`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `email_otps_link_token_unique` (`link_token`),
  ...
  ADD KEY `email_otps_used_index` (`used`);
...
ALTER TABLE `order_items`
  ...
  ADD KEY `order_items_provider_id_foreign` (`provider_id`);
...
ALTER TABLE `transactions`
  ...
  ADD KEY `transactions_order_id_user_id_index` (`order_id`,`user_id`),
  ADD KEY `transactions_gateway_payment_id_index` (`gateway_payment_id`),
  ADD KEY `transactions_gateway_order_id_index` (`gateway_order_id`);
...
--
ALTER TABLE `discount_codes`
  ADD CONSTRAINT `discount_codes_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `discount_code_category`
--
ALTER TABLE `discount_code_category`
  ADD CONSTRAINT `discount_code_category_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `discount_code_category_discount_code_id_foreign` FOREIGN KEY (`discount_code_id`) REFERENCES `discount_codes` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `order_items`
  ...
  ADD CONSTRAINT `order_items_provider_id_foreign` FOREIGN KEY (`provider_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `products`
  ...
  ADD CONSTRAINT `products_provider_id_foreign` FOREIGN KEY (`provider_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `user_addresses`
  ...
  ADD CONSTRAINT `user_addresses_state_id_foreign` FOREIGN KEY (`state_id`) REFERENCES `states` (`id`) ON DELETE CASCADE,
