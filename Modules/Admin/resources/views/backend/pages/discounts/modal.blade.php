<!-- Single Discount Modal for Create and Edit -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="discountForm" method="POST" action="{{ route('admin.discounts.store') }}">
                    @csrf
                    <input type="hidden" name="_method" id="discountMethod" value="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <div id="categoriesContainer">
                                <!-- Categories will be dynamically populated here - at least one dropdown always visible -->
                            </div>
