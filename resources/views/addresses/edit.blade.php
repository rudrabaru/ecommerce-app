            ...
            <div class="col-lg-8">
                <div class="checkout__form">
                    ...
                    <form method="POST" action="{{ route('addresses.update', $address) }}">
                        ...
                        <div class="checkout__input">
                            <p>Company</p>
                            <input type="text" name="company" value="{{ old('company', $address->company) }}" placeholder="Company (optional)">
                            @error('company')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="checkout__input">
                            ...
                            <input type="text" name="address_line_1" value="{{ old('address_line_1', $address->address_line_1) }}" placeholder="Street address" required>
                        ...
                        <div class="checkout__input">
                            <p>Address Line 2</p>
                            <input type="text" name="address_line_2" value="{{ old('address_line_2', $address->address_line_2) }}" placeholder="Apartment, suite, unit, etc. (optional)">
